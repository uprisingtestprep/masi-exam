/* MAS-I Exam Simulator, Application Logic */

const ACCESS_CODE  = "MASI9000";
const EXAM_SECONDS = 14400;
const PASSING_PCT  = 70;
const STORAGE_KEY  = "masi_exam_state_v1";
const SIM_Q_COUNT  = 45;  // simulator serves this project's configured pool size (config.json exam.sim_questions)
const CLUSTER_LABEL = "Case";
const DOMAIN_LABELS = {"probability_models": "Probability Models", "statistical_inference": "Statistical Inference", "generalized_linear_models": "Generalized Linear Models"};  // maps domain key -> human-readable label for display
